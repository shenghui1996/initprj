 ...
 * @author akiraly
 */
public class GBCage extends com.github.cage.Cage {
	/**
	 ...
	 */
	protected GBCage(Random rnd) {
		super(new Painter(WIDTH, HEIGHT, null, null, new EffectConfig(true,
				false, false, false, new ScaleConfig(0.55f, 0.55f)), rnd), null,
				new ConstantColorGenerator(Color.GRAY), null,
